...
class TestExternalXarrayDataset(TestCase):
    ...
    def test_constructor(self):
        ...
        xr_dset = ExternalXarrayDataset(name="test_xarray", path=self.xr_path)
    ...
    def test_constructor_path(self):
        ...
        xr_dset = ExternalXarrayDataset(name="test_xarray", path=Path(self.xr_path))
    ...
    def test_constructor_warn_wrong_ext(self):
        ...
        with self.assertWarnsWith(UserWarning, msg):
            ExternalXarrayDataset(name="test_xarray", path="wrong_extension")
