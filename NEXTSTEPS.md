...
# Next Steps for ndx-xarray Extension for NWB
...
`spec/ndx-xarray.namespace.yaml` and
`spec/ndx-xarray.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-xarray
...
`staged-extensions/ndx-xarray`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-xarray
    ```

13. Edit `staged-extensions/ndx-xarray/ndx-meta.yaml`
...
14. Edit `staged-extensions/ndx-xarray/README.md`
to add information about your extension. You may copy it from
`ndx-xarray/README.md`.

  ```bash
  cp ndx-xarray/README.md staged-extensions/ndx-xarray/README.md
  ```
...
git add ndx-xarray
git commit -m "Add new catalog entry for ndx-xarray" .
git push
```
...
ndx-xarray-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-xarray GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-xarray-record repository on GitHub.
